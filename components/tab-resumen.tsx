    ...
    <div className="py-8 flex flex-col items-center">
      <div className="w-full max-w-3xl mx-auto px-4 text-center">
        <div className="space-y-4 mb-12">
          ...
          <div className="w-20 h-1 bg-gradient-to-r from-primary to-primary/40 rounded-full mx-auto" />
        </div>

        <div className="space-y-6 text-center">
          <p className="text-lg text-foreground/85 leading-relaxed">
            En esta primera clase damos inicio al recorrido del espacio curricular
            <strong className="text-primary font-semibold"> Alfabetización Digital</strong>.
          ...
          <p className="text-foreground/70 leading-relaxed">
            ...
            la temática de la <strong className="text-foreground/85">inteligencia artificial generativa</strong> y
            su potencial transformador en los contextos educativos.
          </p>

          <p className="text-foreground/70 leading-relaxed">
            Como consigna inicial, proponemos la escritura de una
            <strong className="text-foreground/85"> escena de aprendizaje</strong>: una narración
